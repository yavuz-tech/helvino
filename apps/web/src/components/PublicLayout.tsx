...
const ICON_CLS = "w-5 h-5 text-[#4B45FF]";
        ...
        >
          {dropdown.items.map((item) => (
            ...
            >
              ...
              <div>
                <span className="text-sm font-medium text-slate-900 group-hover:text-[#4B45FF] transition-colors">
...
export default function PublicLayout({
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      {/* ── Announcement bar ── */}
      <div className="bg-gradient-to-r from-[#EDEDFF] via-[#EDEDFF]/90 to-[#E0E0FF]/80 border-b border-[#4B45FF]/10 text-center py-2 px-4">
        <p className="text-sm text-[#2E29D6] font-medium">
          ✨ {t("nav.announcement")}
        </p>
      </div>

      {/* ── Header ── */}
      <header className="border-b border-slate-200/60 bg-white/80 backdrop-blur-xl sticky top-0 z-40 shadow-[0_1px_0_rgba(0,0,0,0.03)]">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 h-[72px]">
          ...
          <div className="hidden lg:flex items-center gap-1 ml-auto">
            ...
            <Link
              href="/signup"
              className="inline-flex items-center justify-center gap-1.5 px-5 py-2.5 text-sm font-semibold text-white rounded-xl bg-gradient-to-r from-[#4B45FF] to-[#6C67FF] hover:from-[#3B35EF] hover:to-[#4B45FF] shadow-[0_2px_8px_rgba(75,69,255,0.35)] hover:shadow-[0_4px_14px_rgba(75,69,255,0.4)] transition-all duration-200 hover:-translate-y-0.5"
            >
              {t("home.ctaStartFree")}
          ...
          <div className="lg:hidden border-t border-slate-200 bg-white max-h-[80vh] overflow-y-auto">
            ...
            <div className="p-4 space-y-2 border-t border-slate-100">
              <Link
                href="/signup"
                onClick={closeMobile}
                className="inline-flex items-center justify-center gap-1.5 w-full py-3 text-sm font-semibold text-white rounded-xl bg-gradient-to-r from-[#4B45FF] to-[#6C67FF] hover:from-[#3B35EF] hover:to-[#4B45FF] shadow-[0_2px_8px_rgba(75,69,255,0.35)] transition-all duration-200"
              >
                {t("home.ctaStartFree")}
                <span className="text-white/90">→</span>
              </Link>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-10 mb-14">
            ...
            <div className="col-span-2 sm:col-span-3 lg:col-span-1">
              ...
              <div className="flex gap-2 mt-5">
                <a
                  ...
                  className="w-9 h-9 rounded-full border border-slate-600 flex items-center justify-center text-slate-400 hover:border-[#4B45FF]/50 hover:text-[#6C67FF] transition-colors"
                  aria-label="Twitter"
                >
            ...
            {FOOTER_COLUMNS.map((col) => (
              <div key={col.headingKey}>
                <h4 className="text-[11px] font-semibold text-[#6C67FF] uppercase tracking-wider mb-4">
