...
export default function TestimonialCard({
  ...
  return (
    <div className="relative bg-white rounded-2xl border border-slate-200/80 p-8 shadow-[0_1px_3px_rgba(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgba(75,69,255,0.08)] transition-all duration-300 hover:-translate-y-0.5">
      {/* Quote mark */}
      <div className="absolute -top-3 left-6 w-8 h-8 rounded-full bg-[#4B45FF] flex items-center justify-center">
      ...
      <div className="flex items-center gap-3">
        {avatarUrl ? (
          ...
          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#4B45FF] to-[#6C67FF] flex items-center justify-center text-white text-sm font-bold">
            {author.charAt(0)}
          </div>
        )}
        <div>
